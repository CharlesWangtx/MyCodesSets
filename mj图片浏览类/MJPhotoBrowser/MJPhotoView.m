...
//    
//    //当手指离开屏幕时,将lastscale设置为1.0 缩小不能比原图片小
//    if([(UIPinchGestureRecognizer*)sender state] == UIGestureRecognizerStateEnded) {
//        if (lastScale<self.minimumZoomScale) {
//            CGAffineTransform newTransform = CGAffineTransformScale(oldtransform, 1.0, 1.0);
...
- (void)adjustFrame
{
    ...
    // 内容尺寸
    self.contentSize = CGSizeMake(0, imageHeight);
...
//        _imageView.frame = [_photo.srcImageView convertRect:_photo.srcImageView.bounds toView:nil];
        ...
        _imageView.frame = CGRectMake(.25*imageHeight * boundsWidth / imageWidth, 0+64, boundsWidth*.5, .5*imageHeight * boundsWidth / imageWidth);
